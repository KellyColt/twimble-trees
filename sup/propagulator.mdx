...
The Propagulator (TM) is a machine which turns 5 bonemeal into 1 Mangrove Propagule.
...
<Frame>
  <img
    src="/images/propagulator_main.png"
    alt="quarter view of the Propagulator Hut"
    title="Propagulator Main"
  />
</Frame>
...
<Columns cols={2}>
  <Frame
    caption="The first two Dispensers can be found through the Door next to the sign!">
    <img
    class="m-0"
  ...
  <Frame
    caption="The third Dispenser is on the other side!">
    <img
    src="/images/propagulator_disp_b.png"
    title="Propagulator Dispenser 3"
    alt="labelled picture showing Dispenser 3"
    />
  </Frame>

  <Frame
    caption="The last two Dispensers are behind the Trapdoor on the back of the farm!">
    <img
