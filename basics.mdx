...
<Frame>
  <img
    src="/images/basics_outside.png"
    title="Basics Outside View"
    alt="a picture showing the Mangrove Farm's marked entrance"
  />
</Frame>
...
<Frame>
  <img
    src="/images/basics_entry.png"
    title="Basics Entrance"
    alt="the ladders leading up"
  />
</Frame>
...
<Frame>
  <img
    src="/images/basics_mainswitch.png"
    title="Basics Main Switch"
    alt="the Mangrove Tree Farm's main switch lever"
  />
</Frame>
...
<Frame>
  <img
    src="/images/basics_inventory.png"
    title="Basics Inventory"
    alt="a sample inventory showing saplings in offhand slot, bonemeal in hotbar, rest filled with dummy Scaffolding"
  />
</Frame>
...
<Frame>
  <img
    src="/images/basics_bonemeal.png"
    title="Basics Bonemeal"
    alt="the player's view of the bonemeal dispensary lever"
  />
</Frame>

Once your Bonemeal stack is full, it should stop being dispensed as the items remain on the pressure plate.

<Tip>Should the Bonemeal not immediately start dropping, give it a moment to arrive before panicking!</Tip>
